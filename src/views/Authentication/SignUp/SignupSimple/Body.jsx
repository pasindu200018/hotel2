                                    ...
                                    <Row className="gx-3 mt-7">
                                        <Col lg={6}>
                                            <Card className="card-shadow">
                                                <Card.Img variant="top" src={slide3} alt="Card img cap" />
                                                <Card.Body>
                                        ...
                                        <Col lg={6}>
                                            <Card className="card-shadow">
                                                <Card.Img variant="top" src={slide4} alt="Card img cap" />
                                                <Card.Body>
                            ...
                            <Form className="w-100">
                                <Row>
                                    <Col lg={10} className="mx-auto">
                                        ...
                                        <Button variant='primary' className="btn-rounded btn-uppercase btn-block" as={Link} to="login-simple" >Create account</Button>
